...
// Keep managed_auth as a re-export alias for backward compatibility with flowrs-airflow imports
pub mod managed_auth {
    pub use crate::auth::{AstronomerAuth, ComposerAuth, MwaaAuth, MwaaTokenType};
}
